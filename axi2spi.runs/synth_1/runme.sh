...
HD_PWD='C:/Users/40010377/Documents/GitHub/axi2spi/axi2spi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_BRG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_BRG.tcl
